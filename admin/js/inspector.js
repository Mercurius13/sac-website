...
const FIELD_CONFIG = {
  ...
  link: { label: 'Sign-up link', input: 'url' },
  activeUntil: { label: 'Active until (last day the link shows)', input: 'date' },
  fallbackText: { label: 'Message shown when the link is inactive', input: 'textarea' },
